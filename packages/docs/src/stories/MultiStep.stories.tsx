...
import { Box, MultiStep, MultiStepProps } from '@gears-ui/react'
...
// Veja como renderizar MultiStep nos estados "primary" e "full" e exportar as histórias Primary e Full
